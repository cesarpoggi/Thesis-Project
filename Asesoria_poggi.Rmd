...
reference_importance <- c("DISCAPACIDAD", "ADULTO MAYOR", "COMEDOR","CLUB DE MADRES", "AMBIENTE", "AREAS&VERDES", "FAMILIAS", "FAMILIAR", "VECINOS", "VECINA", "PROPIETARIOS", "ADJUDICATARIOS", "POSECIONARIOS", "VASO","AGR.", "AGROPECUARIO", "AGROPECUARIA", "ASENTAMIENTO", "URBANIZACION", "URB.", "SECTOR&GRUPO") #cambiar a palabras juntas
