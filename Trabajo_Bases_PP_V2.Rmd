...
n_occur_FULL1 <- data.frame(table(PP_FULL1$rowid)) #casos con doble repetición son casos que tienen dos palabras clave de la misma jerarquía (o que son iguales?), eliminarlos manualmente antes del merge -> Identificarlos como Var1 de n_occur_FULL1 refiere al rowid de PP_FULL1 y con el index_OG_col identificamos el caso que genera dos filas diferentes por repetición de palabra en la misma jerarquía (la misma palabra)

PP_FULL1 <- PP_FULL1 %>%
  filter(!duplicated(rowid)) #Diferencia de 2 filas con la data original, significa que hay una duplicacion en la data original (con esto eliminamos el problema anterior, ya no lo tenemos por qué hacer manualmente)
```
...
PP_FULL2$tipo_orgn_mod[719]<-"CM"
PP_FULL2$tipo_orgn_mod[726]<-"CM"
PP_FULL2$tipo_orgn_mod[727]<-"CM"
PP_FULL2$tipo_orgn_mod[730]<-"CM"
PP_FULL2$tipo_orgn_mod[737]<-"CM"
PP_FULL2$tipo_orgn_mod[738]<-"CM"
PP_FULL2$tipo_orgn_mod[739]<-"CM"
PP_FULL2$tipo_orgn_mod[740]<-"CM"
PP_FULL2$tipo_orgn_mod[741]<-"CM"
PP_FULL2$tipo_orgn_mod[742]<-"CM"
PP_FULL2$tipo_orgn_mod[743]<-"CM"
PP_FULL2$tipo_orgn_mod[744]<-"CM"
PP_FULL2$tipo_orgn_mod[745]<-"CM"
PP_FULL2$tipo_orgn_mod[746]<-"CM"
PP_FULL2$tipo_orgn_mod[840]<-"CM"
PP_FULL2$tipo_orgn_mod[841]<-"CM"
PP_FULL2$tipo_orgn_mod[1330:1333]<-"OB"
PP_FULL2$tipo_orgn_mod[1492:1495]<-"VL"
PP_FULL2$tipo_orgn_mod[2810:2811]<-"VL"
PP_FULL2$tipo_orgn_mod[1821:1824]<-"SG"
PP_FULL2$tipo_orgn_mod[1829:1832]<-"SG"
PP_FULL2$tipo_orgn_mod[2543:2544]<-"SG"
PP_FULL2$tipo_orgn_mod[325:326]<-"OO"
PP_FULL2$tipo_orgn_mod[440:441]<-"OO"
PP_FULL2$tipo_orgn_mod[475]<-"PR"
PP_FULL2$tipo_orgn_mod[476]<-"PR"
```
